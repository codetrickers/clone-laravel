...
use Hlx\Session\SymfonySessionDecorator;
use Hlx\Support\Arr;
use Hlx\Support\Str;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new Hlx HTTP request from server variables.
     *
     * @return static
     */
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using Hlx.
     *
    ...
    /**
     * Create a new request instance from the given Hlx request.
     *
     * @param  \Hlx\Http\Request  $from
     * @param  \Hlx\Http\Request|null  $to
     * @return static
     */
    ...
    /**
     * Create an Hlx request from a Symfony instance.
     *
     ...
     * @param  mixed  $default
     * @return \Hlx\Routing\Route|object|string|null
     */
