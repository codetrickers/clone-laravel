...
use Hlx\Http\Client\Events\ConnectionFailed;
use Hlx\Http\Client\Events\RequestSending;
use Hlx\Http\Client\Events\ResponseReceived;
use Hlx\Support\Arr;
...
class PendingRequest
{
     ...
     *
     * @var \Hlx\Http\Client\Factory|null
     */
    protected $factory;
     ...
     *
     * @var \Hlx\Support\Collection|null
     */
     ...
     *
     * @var \Hlx\Http\Client\Request|null
     */
    protected $request;
     ...
     *
     * @param  \Hlx\Http\Client\Factory|null  $factory
     * @return void
     */
