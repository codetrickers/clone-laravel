...
use Hlx\Broadcasting\Broadcasters\AblyBroadcaster;
use Hlx\Broadcasting\Broadcasters\LogBroadcaster;
use Hlx\Broadcasting\Broadcasters\NullBroadcaster;
use Hlx\Broadcasting\Broadcasters\PusherBroadcaster;
use Hlx\Broadcasting\Broadcasters\RedisBroadcaster;
use Hlx\Bus\UniqueLock;
use Hlx\Contracts\Broadcasting\Factory as FactoryContract;
use Hlx\Contracts\Broadcasting\ShouldBeUnique;
use Hlx\Contracts\Broadcasting\ShouldBroadcastNow;
...
/**
 * @mixin \Hlx\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \Hlx\Contracts\Container\Container  $app
     * @return void
     */
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\Hlx\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
