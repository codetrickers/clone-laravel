...
namespace Hlx\Broadcasting\Broadcasters;

use Closure;
use Exception;
use Hlx\Container\Container;
use Hlx\Contracts\Broadcasting\Broadcaster as BroadcasterContract;
...
abstract class Broadcaster implements BroadcasterContract
{
     ...
     *
     * @var \Hlx\Contracts\Routing\BindingRegistrar
     */
     ...
     *
     * @param  \Hlx\Contracts\Broadcasting\HasBroadcastChannel|string  $channel
     ...
     *
     * @return \Hlx\Contracts\Routing\BindingRegistrar
     */
