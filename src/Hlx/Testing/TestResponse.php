...
namespace Hlx\Testing;

use ArrayAccess;
use Closure;
use Hlx\Contracts\Support\MessageBag;
use Hlx\Contracts\View\View;
use Hlx\Cookie\CookieValuePrefix;
...
use Hlx\Testing\Assert as PHPUnit;
use Hlx\Testing\Constraints\SeeInOrder;
use Hlx\Testing\Fluent\AssertableJson;
use LogicException;
...
class TestResponse implements ArrayAccess
{
     ...
     *
     * @return \Hlx\Testing\AssertableJsonString
     *
     * @throws \Throwable
     */
     ...
     *
     * @param  \Hlx\Support\Collection  $exceptions
     * @return $this
     */
