 ...
 * @method static \Hlx\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \Hlx\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static \Hlx\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \Hlx\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \Hlx\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \Hlx\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \Hlx\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \Hlx\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \Hlx\Foundation\Application useEnvironmentPath(string $path)
 * @method static \Hlx\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \Hlx\Support\ServiceProvider register(\Hlx\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \Hlx\Support\ServiceProvider|null getProvider(\Hlx\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\Hlx\Support\ServiceProvider|string $provider)
 * @method static \Hlx\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static \Hlx\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \Hlx\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \Hlx\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \Hlx\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \Hlx\Foundation\Application getInstance()
 * @method static \Hlx\Contracts\Container\Container|\Hlx\Foundation\Application setInstance(\Hlx\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Hlx\Foundation\Application
 */
