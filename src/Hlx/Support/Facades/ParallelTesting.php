 ...
 * @method static void callSetUpTestCaseCallbacks(\Hlx\Foundation\Testing\TestCase $testCase)
 * @method static void callSetUpTestDatabaseCallbacks(string $database)
 * @method static void callTearDownProcessCallbacks()
 * @method static void callTearDownTestCaseCallbacks(\Hlx\Foundation\Testing\TestCase $testCase)
 * @method static mixed option(string $option)
 * @method static string|false token()
 *
 * @see \Hlx\Testing\ParallelTesting
 */
class ParallelTesting extends Facade
{
    ...
    {
        return \Hlx\Testing\ParallelTesting::class;
    }
}
