 ...
 * @method static \Hlx\Session\SessionManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \Hlx\Contracts\Container\Container getContainer()
 * @method static \Hlx\Session\SessionManager setContainer(\Hlx\Contracts\Container\Container $container)
 * @method static \Hlx\Session\SessionManager forgetDrivers()
 ...
 * @method static void setRequestOnHandler(\Hlx\Http\Request $request)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Hlx\Session\SessionManager
 */
