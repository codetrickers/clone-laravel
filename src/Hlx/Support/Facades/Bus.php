...
use Hlx\Bus\BatchRepository;
use Hlx\Contracts\Bus\Dispatcher as BusDispatcherContract;
use Hlx\Foundation\Bus\PendingChain;
use Hlx\Support\Testing\Fakes\BusFake;
 ...
 * @method static \Hlx\Bus\Batch|null findBatch(string $batchId)
 * @method static \Hlx\Bus\PendingBatch batch(\Hlx\Support\Collection|array|mixed $jobs)
 * @method static \Hlx\Foundation\Bus\PendingChain chain(\Hlx\Support\Collection|array $jobs)
 ...
 * @method static \Hlx\Bus\Dispatcher pipeThrough(array $pipes)
 * @method static \Hlx\Bus\Dispatcher map(array $map)
 * @method static \Hlx\Support\Testing\Fakes\BusFake except(array|string $jobsToDispatch)
 ...
 * @method static \Hlx\Support\Collection dispatched(string $command, callable|null $callback = null)
 * @method static \Hlx\Support\Collection dispatchedSync(string $command, callable|null $callback = null)
 * @method static \Hlx\Support\Collection dispatchedAfterResponse(string $command, callable|null $callback = null)
 * @method static \Hlx\Support\Collection batched(callable $callback)
 ...
 * @method static \Hlx\Bus\Batch dispatchFakeBatch(string $name = '')
 * @method static \Hlx\Bus\Batch recordPendingBatch(\Hlx\Bus\PendingBatch $pendingBatch)
 *
 * @see \Hlx\Bus\Dispatcher
 * @see \Hlx\Support\Testing\Fakes\BusFake
 */
class Bus extends Facade
{
     ...
     * @param  \Hlx\Bus\BatchRepository|null  $batchRepository
     * @return \Hlx\Support\Testing\Fakes\BusFake
     */
