 ...
 * @method static \Hlx\Database\Connection getConnection()
 * @method static \Hlx\Database\Schema\Builder setConnection(\Hlx\Database\Connection $connection)
 * @method static void blueprintResolver(\Closure $resolver)
 *
 * @see \Hlx\Database\Schema\Builder
 */
