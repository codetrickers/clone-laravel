...
/**
 * @method static \Hlx\Http\Request capture()
 * @method static \Hlx\Http\Request instance()
 ...
 * @method static \Hlx\Http\Request merge(array $input)
 * @method static \Hlx\Http\Request mergeIfMissing(array $input)
 * @method static \Hlx\Http\Request replace(array $input)
 * @method static mixed get(string $key, mixed $default = null)
 * @method static \Symfony\Component\HttpFoundation\ParameterBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \Hlx\Http\Request createFrom(\Hlx\Http\Request $from, \Hlx\Http\Request|null $to = null)
 * @method static \Hlx\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \Hlx\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 ...
 * @method static \Hlx\Contracts\Session\Session session()
 * @method static void setLaravelSession(\Hlx\Contracts\Session\Session $session)
 * @method static void setRequestLocale(string $locale)
 * @method static void setDefaultRequestLocale(string $locale)
 * @method static mixed user(string|null $guard = null)
 * @method static \Hlx\Routing\Route|object|string|null route(string|null $param = null, mixed $default = null)
 * @method static string fingerprint()
 * @method static \Hlx\Http\Request setJson(\Symfony\Component\HttpFoundation\ParameterBag $json)
 * @method static \Closure getUserResolver()
 * @method static \Hlx\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \Hlx\Http\Request setRouteResolver(\Closure $callback)
 ...
 * @method static string|array|null old(string|null $key = null, \Hlx\Database\Eloquent\Model|string|array|null $default = null)
 ...
 * @method static \Hlx\Http\Request|mixed whenHas(string $key, callable $callback, callable|null $default = null)
 ...
 * @method static \Hlx\Http\Request|mixed whenFilled(string $key, callable $callback, callable|null $default = null)
 * @method static bool missing(string|array $key)
 * @method static \Hlx\Http\Request|mixed whenMissing(string $key, callable $callback, callable|null $default = null)
 * @method static array keys()
 * @method static array all(array|mixed|null $keys = null)
 * @method static mixed input(string|null $key = null, mixed $default = null)
 * @method static \Hlx\Support\Stringable str(string $key, mixed $default = null)
 * @method static \Hlx\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \Hlx\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 * @method static object|null enum(string $key, string $enumClass)
 * @method static \Hlx\Support\Collection collect(array|string|null $key = null)
 ...
 * @method static \Hlx\Http\UploadedFile|\Hlx\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static never dd(mixed ...$keys)
 * @method static \Hlx\Http\Request dump(mixed $keys = [])
