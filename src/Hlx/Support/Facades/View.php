...
/**
 * @method static \Hlx\Contracts\View\View file(string $path, \Hlx\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Hlx\Contracts\View\View make(string $view, \Hlx\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Hlx\Contracts\View\View first(array $views, \Hlx\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \Hlx\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \Hlx\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \Hlx\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \Hlx\View\Factory addNamespace(string $namespace, string|array $hints)
 * @method static \Hlx\View\Factory prependNamespace(string $namespace, string|array $hints)
 * @method static \Hlx\View\Factory replaceNamespace(string $namespace, string|array $hints)
 ...
 * @method static \Hlx\View\Engines\EngineResolver getEngineResolver()
 * @method static \Hlx\View\ViewFinderInterface getFinder()
 * @method static void setFinder(\Hlx\View\ViewFinderInterface $finder)
 ...
 * @method static void setContainer(\Hlx\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\Hlx\Contracts\View\View|\Hlx\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\Hlx\Contracts\View\View $view)
 * @method static void callCreator(\Hlx\Contracts\View\View $view)
