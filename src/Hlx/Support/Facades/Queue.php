...
use Hlx\Support\Testing\Fakes\QueueFake;
 ...
 * @method static \Hlx\Contracts\Queue\Queue connection(string|null $name = null)
 ...
 * @method static \Hlx\Queue\QueueManager setApplication(\Hlx\Contracts\Foundation\Application $app)
 ...
 * @method static \Hlx\Contracts\Queue\Job|null pop(string|null $queue = null)
 * @method static string getConnectionName()
 * @method static \Hlx\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 * @method static \Hlx\Container\Container getContainer()
 * @method static void setContainer(\Hlx\Container\Container $container)
 * @method static \Hlx\Support\Testing\Fakes\QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static \Hlx\Support\Collection pushed(string $job, callable|null $callback = null)
 * @method static bool hasPushed(string $job)
 * @method static bool shouldFakeJob(object $job)
 * @method static array pushedJobs()
 *
 * @see \Hlx\Queue\QueueManager
 * @see \Hlx\Queue\Queue
 * @see \Hlx\Support\Testing\Fakes\QueueFake
 */
class Queue extends Facade
{
     ...
     * @return \Hlx\Support\Testing\Fakes\QueueFake
     */
