 ...
 *
 * @method \Hlx\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Hlx\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Hlx\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \Hlx\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Hlx\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \Hlx\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \Hlx\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \Hlx\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \Hlx\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Hlx\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \Hlx\Support\Carbon fromSerialized($value)
 ...
 * @method \Hlx\Support\Carbon|null getTestNow()
 ...
 * @method \Hlx\Support\Carbon instance($date)
 ...
 * @method \Hlx\Support\Carbon|null make($var)
 * @method \Hlx\Support\Carbon maxValue()
 * @method \Hlx\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \Hlx\Support\Carbon now($tz = null)
 * @method \Hlx\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method \Hlx\Support\Carbon today($tz = null)
 * @method \Hlx\Support\Carbon tomorrow($tz = null)
 ...
 * @method \Hlx\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
