...
use Hlx\Contracts\Process\InvokedProcess as InvokedProcessContract;
...
class FakeInvokedProcess implements InvokedProcessContract
{
     ...
     *
     * @var \Hlx\Process\FakeProcessDescription
     */
    protected $process;
     ...
     * @param  \Hlx\Process\FakeProcessDescription  $process
     * @return void
     */
