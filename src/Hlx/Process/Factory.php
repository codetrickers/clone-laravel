...
namespace Hlx\Process;

use Closure;
use Hlx\Contracts\Process\ProcessResult as ProcessResultContract;
...
class Factory
{
     ...
     * @param  int  $exitCode
     * @return \Hlx\Process\FakeProcessResult
     */
     ...
     *
     * @return \Hlx\Process\FakeProcessDescription
     */
     ...
     * @return \Hlx\Process\FakeProcessSequence
     */
     ...
     *
     * @param  \Hlx\Process\PendingProcess  $process
     ...
     * @return \Hlx\Contracts\Process\ProcessResult
     */
     ...
     * @return \Hlx\Process\ProcessPoolResults
     */
     ...
     *
     * @return \Hlx\Process\PendingProcess
     */
