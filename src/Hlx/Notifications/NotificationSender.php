...
use Hlx\Database\Eloquent\Collection as ModelCollection;
use Hlx\Database\Eloquent\Model;
use Hlx\Notifications\Events\NotificationSending;
use Hlx\Notifications\Events\NotificationSent;
...
class NotificationSender
{
     ...
     *
     * @var \Hlx\Notifications\ChannelManager
     */
    protected $manager;
     ...
     * @param  \Hlx\Contracts\Bus\Dispatcher  $bus
     ...
     *
     * @param  mixed  $notifiables
     * @return \Hlx\Database\Eloquent\Collection|array
     */
