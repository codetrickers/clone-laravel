...
namespace Hlx\Notifications\Channels;

use Hlx\Contracts\Mail\Factory as MailFactory;
use Hlx\Contracts\Mail\Mailable;
use Hlx\Contracts\Queue\ShouldQueue;
use Hlx\Mail\Markdown;
use Hlx\Notifications\Notification;
use Hlx\Support\Arr;
use Hlx\Support\Str;
...
class MailChannel
{
     ...
     *
     * @var \Hlx\Contracts\Mail\Factory
     */
    protected $mailer;
     ...
     *
     * @param  \Hlx\Contracts\Mail\Factory  $mailer
     ...
     * @param  mixed  $notifiable
     * @param  \Hlx\Notifications\Notification  $notification
     * @param  \Hlx\Notifications\Messages\MailMessage  $message
     * @return \Closure
     */
     ...
     *
     * @param  \Hlx\Mail\Message  $mailMessage
     * @param  mixed  $notifiable
     * @param  \Hlx\Notifications\Notification  $notification
     * @param  \Hlx\Notifications\Messages\MailMessage  $message
     * @return void
