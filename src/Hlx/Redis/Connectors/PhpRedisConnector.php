...
use Hlx\Redis\Connections\PhpRedisClusterConnection;
use Hlx\Redis\Connections\PhpRedisConnection;
use Hlx\Support\Arr;
use Hlx\Support\Facades\Redis as RedisFacade;
use Hlx\Support\Str;
use LogicException;
use Redis;
use RedisCluster;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \Hlx\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \Hlx\Redis\Connections\PhpRedisClusterConnection
     */
