...
namespace Hlx\Redis\Connections;

use Closure;
use Hlx\Contracts\Events\Dispatcher;
use Hlx\Redis\Events\CommandExecuted;
use Hlx\Redis\Limiters\ConcurrencyLimiterBuilder;
use Hlx\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \Hlx\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \Hlx\Redis\Limiters\DurationLimiterBuilder
     */
