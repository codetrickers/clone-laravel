...
use Closure;
use Hlx\Contracts\Redis\Factory;
use Hlx\Redis\Connections\Connection;
use Hlx\Redis\Connectors\PhpRedisConnector;
use Hlx\Redis\Connectors\PredisConnector;
use Hlx\Support\Arr;
use Hlx\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \Hlx\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param  \Hlx\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return \Hlx\Redis\Connections\Connection
     */
     ...
     *
     * @return \Hlx\Contracts\Redis\Connector|null
     */
