...
namespace Hlx\Redis\Limiters;

use Hlx\Contracts\Redis\LimiterTimeoutException;
...
class DurationLimiter
{
     ...
     *
     * @var \Hlx\Redis\Connections\Connection
     */
    private $redis;
     ...
     *
     * @param  \Hlx\Redis\Connections\Connection  $redis
     * @param  string  $name
     * @param  int  $maxLocks
     * @param  int  $decay
     * @return void
     ...
     * @return mixed
     *
     * @throws \Hlx\Contracts\Redis\LimiterTimeoutException
     */
