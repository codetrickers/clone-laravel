...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \Hlx\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param  \Hlx\Session\SessionManager  $manager
    ...
    protected function handleStatefulRequest(Request $request, $session, Closure $next)
    {
        ...
        // so that the data is ready for an application. Note that the Hlx sessions
