...
class Schedule
{
     ...
     *
     * @var \Hlx\Console\Scheduling\EventMutex
     */
     ...
     *
     * @var \Hlx\Console\Scheduling\SchedulingMutex
     */
     ...
     *
     * @var \Hlx\Contracts\Bus\Dispatcher
     */
    ...
    public function __construct($timezone = null)
    {
        ...
        if (! class_exists(Container::class)) {
            throw new RuntimeException(
                'A container implementation is required to use the scheduler. Please install the hlx/container package.'
            );
        }
     ...
     * @return \Hlx\Console\Scheduling\CallbackEvent
     */
     ...
     * @param  array  $parameters
     * @return \Hlx\Console\Scheduling\Event
     */
    ...
    protected function dispatchToQueue($job, $queue, $connection)
    {
        if ($job instanceof Closure) {
            if (! class_exists(CallQueuedClosure::class)) {
                throw new RuntimeException(
                    'To enable support for closure jobs, please install the hlx/queue package.'
                );
            }
     ...
     *
     * @return \Hlx\Contracts\Bus\Dispatcher
     *
     * @throws \RuntimeException
     */
    protected function getDispatcher()
    {
        if ($this->dispatcher === null) {
            try {
                ...
                throw new RuntimeException(
                    'Unable to resolve the dispatcher from the service container. Please bind it or install the hlx/bus package.',
