...
class ScheduleListCommand extends Command
{
     ...
     *
     * @param  \Hlx\Support\Collection  $events
     ...
     */
    private function sortEvents(\Hlx\Support\Collection $events, DateTimeZone $timezone)
    {
     ...
     *
     * @param  \Hlx\Console\Scheduling\CallbackEvent  $event
     * @return string
     */
    private function getClosureLocation(CallbackEvent $event)
    {
        ...
        if ($callback instanceof Closure) {
            ...
            return sprintf(
                '%s:%s',
                str_replace($this->hlx->basePath().DIRECTORY_SEPARATOR, '', $function->getFileName() ?: ''),
