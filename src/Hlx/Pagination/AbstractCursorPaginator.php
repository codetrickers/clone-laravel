...
use Hlx\Http\Resources\Json\JsonResource;
use Hlx\Support\Arr;
use Hlx\Support\Collection;
use Hlx\Support\Str;
use Hlx\Support\Traits\ForwardsCalls;
use Hlx\Support\Traits\Tappable;
use Traversable;

/**
 * @mixin \Hlx\Support\Collection
 */
abstract class AbstractCursorPaginator implements Htmlable
{
     ...
     * The current cursor.
     *
     * @var \Hlx\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param  \Hlx\Pagination\Cursor|null  $cursor
     * @return string
     */
     ...
     *
     * @return \Hlx\Pagination\Cursor|null
     */
     ...
     *
     * @param  \Hlx\Support\Collection  $collection
     * @return $this
     */
