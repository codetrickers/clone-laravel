...
use Hlx\Contracts\Routing\BindingRegistrar;
use Hlx\Contracts\Routing\Registrar as RegistrarContract;
...
use Hlx\Routing\Events\RouteMatched;
use Hlx\Routing\Events\Routing;
use Hlx\Support\Arr;
use Hlx\Support\Collection;
use Hlx\Support\Str;
use Hlx\Support\Stringable;
...
/**
 * @mixin \Hlx\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \Hlx\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     * @param  \Hlx\Container\Container|null  $container
     * @return void
     */
    ...
    {
        return $this->any($uri, '\Hlx\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\Hlx\Routing\ViewController')
                ->setDefaults([
                    'view' => $view,
                    'data' => $data,
     ...
     *
     * @param  \Hlx\Support\Collection  $middlewares
     * @return array
     */
     ...
     * @throws \Hlx\Routing\Exceptions\BackedEnumCaseNotFoundException
     */
     ...
     *
     * @return \Hlx\Routing\RouteCollectionInterface
     */
     ...
     *
     * @param  \Hlx\Routing\RouteCollection  $routes
     * @return void
     */
