...
use BackedEnum;
use Closure;
use Hlx\Contracts\Routing\UrlGenerator as UrlGeneratorContract;
...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \Hlx\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param  \Hlx\Routing\RouteCollectionInterface  $routes
     ...
     * @return string
     *
     * @throws \Hlx\Routing\Exceptions\UrlGenerationException
     */
     ...
     * @param  string  $root
     * @param  string  $path
     * @param  \Hlx\Routing\Route|null  $route
     * @return string
     */
     ...
     *
     * @return \Hlx\Routing\RouteUrlGenerator
     */
     ...
     *
     * @param  callable  $keyResolver
     * @return \Hlx\Routing\UrlGenerator
     */
