...
use Closure;
use Hlx\Cache\RateLimiter;
use Hlx\Cache\RateLimiting\Unlimited;
use Hlx\Http\Exceptions\HttpResponseException;
use Hlx\Http\Exceptions\ThrottleRequestsException;
use Hlx\Support\Arr;
...
class ThrottleRequests
{
     ...
     *
     * @param  \Hlx\Cache\RateLimiter  $limiter
     * @return void
     */
     ...
     *
     * @throws \Hlx\Http\Exceptions\ThrottleRequestsException
     */
     ...
     * @return \Hlx\Http\Exceptions\ThrottleRequestsException
     */
