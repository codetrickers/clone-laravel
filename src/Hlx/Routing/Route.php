...
use Hlx\Routing\Contracts\CallableDispatcher;
use Hlx\Routing\Contracts\ControllerDispatcher as ControllerDispatcherContract;
use Hlx\Routing\Controllers\HasMiddleware;
use Hlx\Routing\Matching\HostValidator;
use Hlx\Routing\Matching\MethodValidator;
use Hlx\Routing\Matching\SchemeValidator;
use Hlx\Routing\Matching\UriValidator;
use Hlx\Support\Arr;
use Hlx\Support\Str;
...
class Route
{
    ...
    public function getMissing()
    {
        ...
        return is_string($missing) &&
            Str::startsWith($missing, [
                'O:47:"Hlx\\SerializableClosure\\SerializableClosure',
                'O:55:"Hlx\\SerializableClosure\\UnsignedSerializableClosure',
     ...
     *
     * @return \Hlx\Routing\Contracts\ControllerDispatcher
     */
