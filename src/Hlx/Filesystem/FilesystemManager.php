...
use Aws\S3\S3Client;
use Closure;
use Hlx\Contracts\Filesystem\Factory as FactoryContract;
use Hlx\Support\Arr;
...
/**
 * @mixin \Hlx\Contracts\Filesystem\Filesystem
 * @mixin \Hlx\Filesystem\FilesystemAdapter
 */
class FilesystemManager implements FactoryContract
{
     ...
     *
     * @param  array  $config
     * @return \Hlx\Contracts\Filesystem\Cloud
     */
