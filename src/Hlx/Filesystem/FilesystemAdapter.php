...
namespace Hlx\Filesystem;

use Closure;
use Hlx\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use Hlx\Contracts\Filesystem\Filesystem as FilesystemContract;
use Hlx\Http\File;
use Hlx\Http\UploadedFile;
use Hlx\Support\Arr;
use Hlx\Support\Str;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  string  $path
     * @param  \Psr\Http\Message\StreamInterface|\Hlx\Http\File|\Hlx\Http\UploadedFile|string|resource  $contents
     * @param  mixed  $options
     * @return string|bool
     */
     ...
     *
     * @param  \Hlx\Http\File|\Hlx\Http\UploadedFile|string  $path
     * @param  \Hlx\Http\File|\Hlx\Http\UploadedFile|string|array|null  $file
     * @param  mixed  $options
     * @return string|false
     */
