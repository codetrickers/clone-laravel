...
use Hlx\Foundation\Support\Providers\EventServiceProvider;
...
class EventCacheCommand extends Command
{
    ...
    protected function getEvents()
    {
        ...
        foreach ($this->hlx->getProviders(EventServiceProvider::class) as $provider) {
