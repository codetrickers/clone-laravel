...
use Hlx\Console\Application as Artisan;
use Hlx\Console\Command;
use Hlx\Console\Events\CommandFinished;
use Hlx\Console\Events\CommandStarting;
use Hlx\Console\Scheduling\Schedule;
use Hlx\Contracts\Console\Kernel as KernelContract;
...
class Kernel implements KernelContract
{
     ...
     *
     * @var \Hlx\Console\Application|null
     */
    protected $artisan;
    ...
    protected $bootstrappers = [
        ...
        \Hlx\Foundation\Bootstrap\SetRequestForConsole::class,
    ...
    /**
     * Re-route the Symfony command events to their Hlx counterparts.
     *
     * @internal
     *
     * @return $this
     ...
     * @return \Hlx\Foundation\Console\ClosureCommand
     */
    ...
    public function bootstrapWithoutBootingProviders()
    {
        $this->app->bootstrapWith(
            collect($this->bootstrappers())->reject(function ($bootstrapper) {
                return $bootstrapper === \Hlx\Foundation\Bootstrap\BootProviders::class;
            })->all()
        );
    }
     ...
     *
     * @return \Hlx\Console\Application
     */
     ...
     *
     * @param  \Hlx\Console\Application|null  $artisan
     * @return void
     */
