...
use Hlx\Routing\RouteCollection;
...
class RouteCacheCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->files->put(
            $this->hlx->getCachedRoutesPath(), $this->buildRouteCacheFile($routes)
        );
     ...
     *
     * @return \Hlx\Routing\RouteCollection
     */
    ...
    {
        return tap(require $this->hlx->bootstrapPath('app.php'), function ($app) {
