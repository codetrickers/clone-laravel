...
use Hlx\Contracts\Broadcasting\Broadcaster;
...
class ChannelListCommand extends Command
{
     ...
     *
     * @param  \Hlx\Contracts\Broadcasting\Broadcaster
     * @return void
     */
    public function handle(Broadcaster $broadcaster)
    {
        ...
        if (! $this->hlx->providerIsLoaded('App\Providers\BroadcastServiceProvider') &&
            file_exists($this->hlx->path('Providers/BroadcastServiceProvider.php'))) {
     ...
     *
     * @param  \Hlx\Support\Collection  $channels
     * @return array
     */
