...
use Hlx\Foundation\Events\MaintenanceModeEnabled;
use Hlx\Foundation\Exceptions\RegisterErrorViewPaths;
...
class DownCommand extends Command
{
    ...
    public function handle()
    {
        try {
            ...
            $this->hlx->maintenanceMode()->activate($this->getDownFilePayload());
            ...
            $this->hlx->get('events')->dispatch(new MaintenanceModeEnabled());
    ...
    {
        try {
            return $this->hlx->make(PreventRequestsDuringMaintenance::class)->getExcludedPaths();
        } catch (Throwable) {
            return [];
        }
    }
