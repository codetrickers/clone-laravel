...
use Closure;
use Exception;
use Hlx\Auth\Access\AuthorizationException;
use Hlx\Auth\AuthenticationException;
use Hlx\Console\View\Components\BulletList;
use Hlx\Console\View\Components\Error;
use Hlx\Contracts\Container\Container;
use Hlx\Contracts\Debug\ExceptionHandler as ExceptionHandlerContract;
use Hlx\Contracts\Foundation\ExceptionRenderer;
use Hlx\Contracts\Support\Responsable;
use Hlx\Database\Eloquent\ModelNotFoundException;
use Hlx\Database\MultipleRecordsFoundException;
...
use Hlx\Routing\Exceptions\BackedEnumCaseNotFoundException;
use Hlx\Routing\Router;
use Hlx\Session\TokenMismatchException;
use Hlx\Support\Arr;
use Hlx\Support\Facades\Auth;
use Hlx\Support\Reflector;
use Hlx\Support\Traits\ReflectsClosures;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \Hlx\Contracts\Container\Container
     */
    protected $container;
     ...
     *
     * @var \Hlx\Foundation\Exceptions\ReportableHandler[]
     */
     ...
     *
     * @param  \Hlx\Contracts\Container\Container  $container
     * @return void
     */
     ...
     * @return \Hlx\Foundation\Exceptions\ReportableHandler
     */
     ...
     *
     * @param  \Hlx\Http\Request  $request
     * @param  \Hlx\Auth\AuthenticationException  $exception
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \Hlx\Validation\ValidationException  $e
     * @param  \Hlx\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \Hlx\Http\Request  $request
     * @param  \Hlx\Validation\ValidationException  $exception
    ...
    protected function prepareResponse($request, Throwable $e)
    {
        if (! $this->isHttpException($e) && config('app.debug')) {
            return $this->toHlxResponse($this->convertExceptionToResponse($e), $e)->prepare($request);
        }
    ...
    /**
     * Map the given exception into an Hlx response.
     *
     * @param  \Symfony\Component\HttpFoundation\Response  $response
     * @param  \Throwable  $e
     * @return \Hlx\Http\Response
     */
    protected function toHlxResponse($response, Throwable $e)
    {
