...
use Hlx\Support\Arr;
use Hlx\Support\Facades\DB;
use Hlx\Testing\Constraints\CountInDatabase;
use Hlx\Testing\Constraints\HasInDatabase;
use Hlx\Testing\Constraints\NotSoftDeletedInDatabase;
use Hlx\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  \Hlx\Database\Eloquent\Model|string  $table
     * @param  array  $data
