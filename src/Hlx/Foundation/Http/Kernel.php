...
namespace Hlx\Foundation\Http;

use Carbon\CarbonInterval;
use DateTimeInterface;
use Hlx\Contracts\Debug\ExceptionHandler;
use Hlx\Contracts\Foundation\Application;
use Hlx\Contracts\Http\Kernel as KernelContract;
use Hlx\Foundation\Http\Events\RequestHandled;
use Hlx\Routing\Pipeline;
...
class Kernel implements KernelContract
{
     ...
     *
     * @var \Hlx\Contracts\Foundation\Application
     */
    protected $app;
    ...
    protected $bootstrappers = [
        \Hlx\Foundation\Bootstrap\LoadEnvironmentVariables::class,
        \Hlx\Foundation\Bootstrap\LoadConfiguration::class,
        \Hlx\Foundation\Bootstrap\HandleExceptions::class,
        \Hlx\Foundation\Bootstrap\RegisterFacades::class,
        \Hlx\Foundation\Bootstrap\RegisterProviders::class,
        \Hlx\Foundation\Bootstrap\BootProviders::class,
    ];
    ...
    protected $middlewarePriority = [
        \Hlx\Foundation\Http\Middleware\HandlePrecognitiveRequests::class,
        \Hlx\Cookie\Middleware\EncryptCookies::class,
        \Hlx\Cookie\Middleware\AddQueuedCookiesToResponse::class,
        \Hlx\Session\Middleware\StartSession::class,
        \Hlx\View\Middleware\ShareErrorsFromSession::class,
        \Hlx\Contracts\Auth\Middleware\AuthenticatesRequests::class,
        \Hlx\Routing\Middleware\ThrottleRequests::class,
        \Hlx\Routing\Middleware\ThrottleRequestsWithRedis::class,
        \Hlx\Contracts\Session\Middleware\AuthenticatesSessions::class,
        \Hlx\Routing\Middleware\SubstituteBindings::class,
        \Hlx\Auth\Middleware\Authorize::class,
    ];
     ...
     *
     * @return \Hlx\Support\Carbon|null
     */
    ...
    /**
     * Get the Hlx application instance.
     *
     * @return \Hlx\Contracts\Foundation\Application
     */
    ...
    /**
     * Set the Hlx application instance.
     *
     * @param  \Hlx\Contracts\Foundation\Application  $app
     * @return $this
     */
