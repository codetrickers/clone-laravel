...
use Hlx\Config\Repository as ConfigRepository;
use Hlx\Container\Container;
use Hlx\Contracts\Filesystem\Factory as FilesystemFactory;
use Hlx\Contracts\Mail\Attachable;
use Hlx\Contracts\Mail\Factory as MailFactory;
...
use Hlx\Contracts\Support\Renderable;
use Hlx\Contracts\Translation\HasLocalePreference;
...
use Hlx\Support\Traits\Localizable;
use Hlx\Support\Traits\Macroable;
use Hlx\Testing\Constraints\SeeInOrder;
...
class Mailable implements MailableContract, Renderable
{
     ...
     *
     * @param  \Hlx\Mail\Markdown  $markdown
     * @param  array  $data
     * @return string
     */
     ...
     *
     * @param  string|\Hlx\Contracts\Mail\Attachable|\Hlx\Mail\Attachment  $file
     * @param  array  $options
     * @return $this
     */
     ...
     *
     * @param  \Hlx\Mail\Attachment  $attachment
     * @param  array  $options
     * @return bool
     */
