...
class Envelope
{
     ...
     *
     * @var \Hlx\Mail\Mailables\Address|string|null
     */
    public $from;
     ...
     *
     * @param  \Hlx\Mail\Mailables\Address|string|null  $from
     * @param  array  $to
     * @param  array  $cc
     * @param  array  $bcc
     * @param  array  $replyTo
     ...
     *
     * @param  \Hlx\Mail\Mailables\Address|string  $address
     ...
     *
     * @param  \Hlx\Mail\Mailables\Address|array|string  $address
     * @param  string|null  $name
     * @return $this
     */
