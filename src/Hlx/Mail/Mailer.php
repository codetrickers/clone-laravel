...
use Hlx\Contracts\Mail\Mailable as MailableContract;
use Hlx\Contracts\Mail\Mailer as MailerContract;
use Hlx\Contracts\Mail\MailQueue as MailQueueContract;
use Hlx\Contracts\Queue\Factory as QueueContract;
use Hlx\Contracts\Queue\ShouldQueue;
use Hlx\Contracts\Support\Htmlable;
use Hlx\Contracts\View\Factory;
use Hlx\Mail\Events\MessageSending;
use Hlx\Mail\Events\MessageSent;
use Hlx\Mail\Mailables\Address;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @var \Hlx\Contracts\View\Factory
     */
    protected $views;
     ...
     *
     * @var \Hlx\Contracts\Events\Dispatcher|null
     */
    protected $events;
     ...
     *
     * @param  string  $name
     * @param  \Hlx\Contracts\View\Factory  $views
     * @param  \Symfony\Component\Mailer\Transport\TransportInterface  $transport
     * @param  \Hlx\Contracts\Events\Dispatcher|null  $events
     * @return void
     */
     ...
     *
     * @param  \Hlx\Contracts\Mail\Mailable|string|array  $view
     * @param  array  $data
     ...
     *
     * @param  \Hlx\Contracts\Mail\Mailable  $mailable
     * @return \Hlx\Mail\SentMessage|null
     */
     ...
     *
     * @param  \Hlx\Mail\Message  $message
     * @param  string  $view
     * @param  string  $plain
     * @param  string  $raw
     * @param  array  $data
     ...
     *
     * @param  string  $queue
     * @param  \Hlx\Contracts\Mail\Mailable  $view
     * @return mixed
     */
     ...
     *
     * @param  \Hlx\Mail\SentMessage  $message
     * @param  array  $data
     * @return void
     */
     ...
     *
     * @return \Hlx\Contracts\View\Factory
     */
