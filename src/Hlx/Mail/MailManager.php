...
use Closure;
use Hlx\Contracts\Mail\Factory as FactoryContract;
use Hlx\Log\LogManager;
use Hlx\Mail\Transport\ArrayTransport;
use Hlx\Mail\Transport\LogTransport;
use Hlx\Mail\Transport\SesTransport;
use Hlx\Mail\Transport\SesV2Transport;
use Hlx\Support\Arr;
use Hlx\Support\ConfigurationUrlParser;
use Hlx\Support\Str;
...
class MailManager implements FactoryContract
{
     ...
     *
     * @param  array  $config
     * @return \Hlx\Mail\Transport\SesTransport
     */
     ...
     *
     * @param  array  $config
     * @return \Hlx\Mail\Transport\Se2VwTransport
     */
    ...
    protected function createFailoverTransport(array $config)
    {
        ...
        foreach ($config['mailers'] as $name) {
            ...
            // with any Hlx <= 6.x application style mail configuration files.
     ...
     *
     * @param  array  $config
     * @return \Hlx\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \Hlx\Mail\Transport\ArrayTransport
     */
    ...
    protected function getConfig(string $name)
    {
        ...
        // provide "BC" for any Hlx <= 6.x style mail configuration files.
    ...
    public function getDefaultDriver()
    {
        ...
        // of the Hlx mail configuration file for backwards compatibility.
