...
namespace Hlx\Database\Query;

use BackedEnum;
use Carbon\CarbonPeriod;
use Closure;
use DateTimeInterface;
use Hlx\Contracts\Database\Query\Builder as BuilderContract;
use Hlx\Contracts\Database\Query\Expression as ExpressionContract;
use Hlx\Contracts\Support\Arrayable;
use Hlx\Database\Concerns\BuildsQueries;
use Hlx\Database\Concerns\ExplainsQueries;
use Hlx\Database\ConnectionInterface;
use Hlx\Database\Eloquent\Builder as EloquentBuilder;
use Hlx\Database\Eloquent\Relations\Relation;
use Hlx\Database\Query\Grammars\Grammar;
use Hlx\Database\Query\Processors\Processor;
use Hlx\Pagination\Paginator;
use Hlx\Support\Arr;
use Hlx\Support\Collection;
use Hlx\Support\LazyCollection;
use Hlx\Support\Str;
use Hlx\Support\Traits\ForwardsCalls;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \Hlx\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \Hlx\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \Hlx\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \Hlx\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     *
     * @param  \Hlx\Database\ConnectionInterface  $connection
     * @param  \Hlx\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \Hlx\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\Hlx\Database\Query\Builder|\Hlx\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\Hlx\Database\Query\Builder|\Hlx\Database\Eloquent\Builder|string  $table
     ...
     *
     * @param  \Hlx\Contracts\Database\Query\Expression|string  $table
     ...
     *
     * @param  \Hlx\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \Hlx\Database\Query\JoinClause
     */
     ...
     *
     * @param  \Closure|string|array|\Hlx\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Hlx\Contracts\Database\Query\Expression|string  $column
     * @param  mixed  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @param  string  $column
     * @param  \Hlx\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Hlx\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Hlx\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \Hlx\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Hlx\Database\Query\Builder|\Hlx\Database\Eloquent\Builder  $callback
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  array|\Hlx\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Hlx\Database\Query\Builder|\Hlx\Database\Eloquent\Builder|\Hlx\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Hlx\Database\Query\Builder|\Hlx\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Hlx\Database\Query\Builder|\Hlx\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Hlx\Database\Query\Builder|\Hlx\Database\Eloquent\Builder  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \Hlx\Database\RecordsNotFoundException
     * @throws \Hlx\Database\MultipleRecordsFoundException
     */
     ...
     * @return \Hlx\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Hlx\Contracts\Pagination\Paginator
     */
     ...
     * @param  \Hlx\Pagination\Cursor|string|null  $cursor
     * @return \Hlx\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @return \Hlx\Support\LazyCollection
     */
     ...
     *
     * @param  \Hlx\Contracts\Database\Query\Expression|string  $columns
     * @return int
     */
     ...
     *
     * @param  mixed  $value
     * @return \Hlx\Contracts\Database\Query\Expression
     */
     ...
     *
     * @return \Hlx\Database\ConnectionInterface
     */
     ...
     *
     * @return \Hlx\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Hlx\Database\Query\Grammars\Grammar
     */
