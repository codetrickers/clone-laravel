...
use Hlx\Database\Concerns\CompilesJsonPaths;
use Hlx\Database\Connection;
use Hlx\Database\Grammar as BaseGrammar;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Hlx\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \Hlx\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Hlx\Support\Fluent|null
     */
     ...
     *
     * @param  \Hlx\Support\Fluent|\Hlx\Contracts\Database\Query\Expression|string  $value
