...
namespace Hlx\Database\Schema;

use BadMethodCallException;
use Closure;
use Hlx\Database\Connection;
use Hlx\Database\Eloquent\Concerns\HasUlids;
use Hlx\Database\Query\Expression;
use Hlx\Database\Schema\Grammars\Grammar;
use Hlx\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \Hlx\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     * @return \Hlx\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Hlx\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Hlx\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Hlx\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \Hlx\Database\Schema\ColumnDefinition  $definition
     * @return \Hlx\Database\Schema\ColumnDefinition
     */
