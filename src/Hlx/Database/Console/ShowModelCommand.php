...
class ShowModelCommand extends DatabaseInspectionCommand
{
     ...
     * @param  string  $table
     * @param  string  $policy
     * @param  \Hlx\Support\Collection  $attributes
     * @param  \Hlx\Support\Collection  $relations
     * @param  \Hlx\Support\Collection  $observers
     * @return void
     */
     ...
     * @return string
     *
     * @see \Hlx\Console\GeneratorCommand
     */
    protected function qualifyModel(string $model)
    {
        ...
        $rootNamespace = $this->hlx->getNamespace();
