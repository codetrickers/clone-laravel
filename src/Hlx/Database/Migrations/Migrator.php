...
namespace Hlx\Database\Migrations;

use Doctrine\DBAL\Schema\SchemaException;
use Hlx\Console\View\Components\BulletList;
use Hlx\Console\View\Components\Error;
use Hlx\Console\View\Components\Info;
use Hlx\Console\View\Components\Task;
use Hlx\Console\View\Components\TwoColumnDetail;
use Hlx\Contracts\Events\Dispatcher;
use Hlx\Database\ConnectionResolverInterface as Resolver;
use Hlx\Database\Events\MigrationEnded;
use Hlx\Database\Events\MigrationsEnded;
use Hlx\Database\Events\MigrationsStarted;
use Hlx\Database\Events\MigrationStarted;
use Hlx\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var \Hlx\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @var array<string, \Hlx\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param  \Hlx\Database\Migrations\MigrationRepositoryInterface  $repository
     * @param  \Hlx\Database\ConnectionResolverInterface  $resolver
     * @param  \Hlx\Filesystem\Filesystem  $files
     * @param  \Hlx\Contracts\Events\Dispatcher|null  $dispatcher
     * @return void
     */
     ...
     *
     * @return \Hlx\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \Hlx\Filesystem\Filesystem
     */
     ...
     *
     * @param  \Hlx\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
