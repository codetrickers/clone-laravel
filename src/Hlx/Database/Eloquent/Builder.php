...
use Closure;
use Exception;
use Hlx\Contracts\Database\Eloquent\Builder as BuilderContract;
use Hlx\Contracts\Database\Query\Expression;
use Hlx\Contracts\Support\Arrayable;
use Hlx\Database\Concerns\BuildsQueries;
use Hlx\Database\Eloquent\Concerns\QueriesRelationships;
use Hlx\Database\Eloquent\Relations\BelongsToMany;
use Hlx\Database\Eloquent\Relations\Relation;
use Hlx\Database\Query\Builder as QueryBuilder;
use Hlx\Database\RecordsNotFoundException;
 ...
 *
 * @mixin \Hlx\Database\Query\Builder
 */
class Builder implements BuilderContract
{
     ...
     *
     * @var \Hlx\Database\Query\Builder
     */
    protected $query;
     ...
     * @return \Hlx\Database\Eloquent\Model|static
     */
     ...
     * @param  \Hlx\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \Hlx\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \Hlx\Database\Eloquent\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\Hlx\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\Hlx\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \Hlx\Database\Eloquent\Collection
     */
     ...
     * @return \Hlx\Database\Eloquent\Model|\Hlx\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     *
     * @param  \Hlx\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \Hlx\Database\Eloquent\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return \Hlx\Database\Eloquent\Model|\Hlx\Database\Eloquent\Collection|static|static[]
     *
     * @throws \Hlx\Database\Eloquent\ModelNotFoundException<\Hlx\Database\Eloquent\Model>
     */
     ...
     * @return \Hlx\Database\Eloquent\Model|\Hlx\Database\Eloquent\Collection|static[]|static|mixed
     */
     ...
     * @param  \Closure|array|string  $columns
     * @param  \Closure|null  $callback
     * @return \Hlx\Database\Eloquent\Model|static|mixed
     */
     ...
     *
     * @param  array|string  $columns
     * @return \Hlx\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \Hlx\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \Hlx\Database\Eloquent\Model|$this
     */
     ...
     *
     * @param  array|\Hlx\Contracts\Database\Query\Expression  $columns
     * @return array
     */
