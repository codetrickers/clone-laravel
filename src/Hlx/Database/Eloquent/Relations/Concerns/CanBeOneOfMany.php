...
namespace Hlx\Database\Eloquent\Relations\Concerns;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \Hlx\Database\Eloquent\Builder|null
     */
     ...
     *
     * @param  \Hlx\Database\Eloquent\Builder  $parent
     * @param  \Hlx\Database\Eloquent\Builder  $subQuery
     * @param  string  $on
     * @return void
     */
     ...
     *
     * @return \Hlx\Database\Eloquent\Builder|void
     */
