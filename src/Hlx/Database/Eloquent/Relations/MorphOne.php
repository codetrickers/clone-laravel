...
use Hlx\Contracts\Database\Eloquent\SupportsPartialRelations;
use Hlx\Database\Eloquent\Builder;
use Hlx\Database\Eloquent\Collection;
use Hlx\Database\Eloquent\Model;
use Hlx\Database\Eloquent\Relations\Concerns\CanBeOneOfMany;
use Hlx\Database\Eloquent\Relations\Concerns\ComparesRelatedModels;
use Hlx\Database\Eloquent\Relations\Concerns\SupportsDefaultModels;
use Hlx\Database\Query\JoinClause;
...
class MorphOne extends MorphOneOrMany implements SupportsPartialRelations
{
     ...
     *
     * @param  \Hlx\Database\Query\JoinClause  $join
     * @return void
     */
