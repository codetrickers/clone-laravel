...
/**
 * @method static \Hlx\Database\Eloquent\Builder|\Hlx\Database\Query\Builder withTrashed(bool $withTrashed = true)
 * @method static \Hlx\Database\Eloquent\Builder|\Hlx\Database\Query\Builder onlyTrashed()
 * @method static \Hlx\Database\Eloquent\Builder|\Hlx\Database\Query\Builder withoutTrashed()
 */
trait SoftDeletes
{
    /**
