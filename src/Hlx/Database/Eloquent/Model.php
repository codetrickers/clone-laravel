...
use Hlx\Contracts\Queue\QueueableCollection;
use Hlx\Contracts\Queue\QueueableEntity;
use Hlx\Contracts\Routing\UrlRoutable;
use Hlx\Contracts\Support\Arrayable;
use Hlx\Contracts\Support\CanBeEscapedWhenCastToString;
use Hlx\Contracts\Support\Jsonable;
use Hlx\Database\ConnectionResolverInterface as Resolver;
use Hlx\Database\Eloquent\Collection as EloquentCollection;
use Hlx\Database\Eloquent\Relations\BelongsToMany;
use Hlx\Database\Eloquent\Relations\Concerns\AsPivot;
use Hlx\Database\Eloquent\Relations\HasManyThrough;
use Hlx\Database\Eloquent\Relations\Pivot;
use Hlx\Support\Arr;
use Hlx\Support\Collection as BaseCollection;
use Hlx\Support\Str;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     *
     * @var \Hlx\Database\ConnectionResolverInterface
     */
     ...
     * @return $this
     *
     * @throws \Hlx\Database\Eloquent\MassAssignmentException
     */
     ...
     *
     * @param  string|null  $connection
     * @return \Hlx\Database\Eloquent\Builder
     */
     ...
     * @return \Hlx\Database\Eloquent\Collection<int, static>
     */
     ...
     *
     * @param  \Hlx\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @return \Hlx\Database\Eloquent\Builder|static
     */
     ...
     * @return \Hlx\Database\Eloquent\Relations\Pivot
     */
     ...
     *
     * @param  \Hlx\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \Hlx\Database\Connection
     */
     ...
     *
     * @return \Hlx\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \Hlx\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \Hlx\Database\Eloquent\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \Hlx\Database\Eloquent\Model|\Hlx\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Hlx\Database\Eloquent\Relations\Relation
     */
