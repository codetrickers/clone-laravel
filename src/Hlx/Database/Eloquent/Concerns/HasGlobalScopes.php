...
use Closure;
use Hlx\Database\Eloquent\Scope;
use Hlx\Support\Arr;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \Hlx\Database\Eloquent\Scope|\Closure|string  $scope
     * @param  \Hlx\Database\Eloquent\Scope|\Closure|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \Hlx\Database\Eloquent\Scope|string  $scope
     * @return \Hlx\Database\Eloquent\Scope|\Closure|null
     */
