...
use Hlx\Contracts\Database\Eloquent\CastsInboundAttributes;
use Hlx\Contracts\Support\Arrayable;
use Hlx\Database\Eloquent\Casts\AsArrayObject;
use Hlx\Database\Eloquent\Casts\AsCollection;
use Hlx\Database\Eloquent\Casts\AsEncryptedArrayObject;
use Hlx\Database\Eloquent\Casts\AsEncryptedCollection;
use Hlx\Database\Eloquent\Casts\AsEnumArrayObject;
use Hlx\Database\Eloquent\Casts\AsEnumCollection;
use Hlx\Database\Eloquent\Casts\Attribute;
use Hlx\Database\Eloquent\Casts\Json;
use Hlx\Database\Eloquent\InvalidCastException;
use Hlx\Database\Eloquent\JsonEncodingException;
use Hlx\Database\Eloquent\MissingAttributeException;
use Hlx\Database\Eloquent\Relations\Relation;
use Hlx\Database\LazyLoadingViolationException;
use Hlx\Support\Arr;
use Hlx\Support\Carbon;
use Hlx\Support\Collection as BaseCollection;
use Hlx\Support\Exceptions\MathException;
use Hlx\Support\Facades\Crypt;
use Hlx\Support\Facades\Date;
use Hlx\Support\Facades\Hash;
use Hlx\Support\Str;
...
trait HasAttributes
{
     ...
     *
     * @var \Hlx\Contracts\Encryption\Encrypter|null
     */
     ...
     * @return null
     *
     * @throws \Hlx\Database\Eloquent\MissingAttributeException
     */
     ...
     *
     * @param  \Hlx\Contracts\Encryption\Encrypter|null  $encrypter
     * @return void
     */
     ...
     * @return bool
     *
     * @throws \Hlx\Database\Eloquent\InvalidCastException
     */
