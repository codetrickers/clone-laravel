...
use Hlx\Database\Events\QueryExecuted;
use Hlx\Database\Events\StatementPrepared;
use Hlx\Database\Events\TransactionBeginning;
use Hlx\Database\Events\TransactionCommitted;
use Hlx\Database\Events\TransactionCommitting;
use Hlx\Database\Events\TransactionRolledBack;
use Hlx\Database\Query\Builder as QueryBuilder;
use Hlx\Database\Query\Expression;
use Hlx\Database\Query\Grammars\Grammar as QueryGrammar;
use Hlx\Database\Query\Processors\Processor;
use Hlx\Database\Schema\Builder as SchemaBuilder;
use Hlx\Support\Arr;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \Hlx\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \Hlx\Database\DatabaseTransactionsManager
     */
     ...
     *
     * @return \Hlx\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @return \Hlx\Database\Schema\Builder
     */
     ...
     *
     * @param  \Closure|\Hlx\Database\Query\Builder|\Hlx\Contracts\Database\Query\Expression|string  $table
     ...
     * @return mixed
     *
     * @throws \Hlx\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \Hlx\Database\QueryException
     */
     ...
     *
     * @param  \Hlx\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \Hlx\Database\LostConnectionException
     */
     ...
     *
     * @param  \Hlx\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \Hlx\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \Hlx\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @return \Hlx\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \Hlx\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
