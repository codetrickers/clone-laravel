...
use Hlx\Pagination\Cursor;
use Hlx\Pagination\CursorPaginator;
use Hlx\Pagination\LengthAwarePaginator;
...
trait BuildsQueries
{
     ...
     * @return \Hlx\Database\Eloquent\Model|object|static|null
     */
     ...
     *
     * @param  \Hlx\Database\Query\Builder|\Hlx\Database\Eloquent\Builder  $builder
     ...
     *
     * @param  \Hlx\Support\Collection  $items
     * @param  int  $total
     * @param  int  $perPage
     * @param  int  $currentPage
     * @param  array  $options
     * @return \Hlx\Pagination\LengthAwarePaginator
     */
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \Hlx\Pagination\Paginator
     */
     ...
     * @param  \Hlx\Support\Collection  $items
     * @param  int  $perPage
     * @param  \Hlx\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \Hlx\Pagination\CursorPaginator
     */
