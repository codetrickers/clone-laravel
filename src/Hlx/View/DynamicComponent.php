...
use Hlx\Support\Str;
use Hlx\View\Compilers\ComponentTagCompiler;
...
class DynamicComponent extends Component
{
     ...
     *
     * @var \Hlx\View\Compilers\BladeTagCompiler
     */
     ...
     *
     * @return \Hlx\Contracts\View\View|string
     */
    public function render()
    {
        $template = <<<'EOF'
<?php extract(collect($attributes->getAttributes())->mapWithKeys(function ($value, $key) { return [Hlx\Support\Str::camel(str_replace([':', '.'], ' ', $key)) => $value]; })->all(), EXTR_SKIP); ?>
{{ props }}
...
EOF;
     ...
     *
     * @return \Hlx\View\Compilers\ComponentTagCompiler
     */
