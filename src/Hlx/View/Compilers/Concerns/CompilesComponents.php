...
use Hlx\Support\Str;
use Hlx\View\ComponentAttributeBag;
...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes) && $attributes instanceof Hlx\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>',
    ...
    {
        return "<?php \$attributes ??= new \\Hlx\\View\\ComponentAttributeBag; ?>
