...
use Hlx\Contracts\Support\MessageProvider;
use Hlx\Contracts\Support\Renderable;
use Hlx\Contracts\View\Engine;
use Hlx\Contracts\View\View as ViewContract;
...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @param  \Hlx\View\Factory  $factory
     * @param  \Hlx\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
     ...
     *
     * @param  \Hlx\Contracts\Support\MessageProvider|array  $provider
     * @param  string  $bag
     * @return $this
     */
     ...
     *
     * @param  \Hlx\Contracts\Support\MessageProvider|array|string  $provider
