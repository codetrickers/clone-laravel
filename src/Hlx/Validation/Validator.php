...
use Hlx\Contracts\Translation\Translator;
use Hlx\Contracts\Validation\DataAwareRule;
use Hlx\Contracts\Validation\ImplicitRule;
use Hlx\Contracts\Validation\Rule as RuleContract;
use Hlx\Contracts\Validation\Validator as ValidatorContract;
use Hlx\Contracts\Validation\ValidatorAwareRule;
use Hlx\Support\Arr;
use Hlx\Support\Fluent;
use Hlx\Support\MessageBag;
use Hlx\Support\Str;
use Hlx\Support\ValidatedInput;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Hlx\Contracts\Translation\Translator
     */
     ...
     *
     * @var \Hlx\Validation\PresenceVerifierInterface
     */
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \Hlx\Contracts\Validation\Rule  $rule
     * @return void
     */
     ...
     *
     * @param  string  $attribute
     * @return \Hlx\Support\Fluent|array|mixed
     */
     ...
     * @return \Hlx\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Hlx\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \Hlx\Contracts\Translation\Translator
     */
