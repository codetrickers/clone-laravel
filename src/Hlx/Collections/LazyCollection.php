...
use Hlx\Support\Traits\EnumeratesValues;
 ...
 *
 * @implements \Hlx\Support\Enumerable<TKey, TValue>
 */
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \Hlx\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \Hlx\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|(Closure(): \Generator<TKey, TValue, mixed, void>)|self<TKey, TValue>|array<TKey, TValue>|null  $source
     * @return void
     */
     ...
     * @template TMakeValue
     *
     * @param  \Hlx\Contracts\Support\Arrayable<TMakeKey, TMakeValue>|iterable<TMakeKey, TMakeValue>|(Closure(): \Generator<TMakeKey, TMakeValue, mixed, void>)|self<TMakeKey, TMakeValue>|array<TMakeKey, TMakeValue>|null  $items
     ...
     *
     * @param  \Hlx\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$arrays
     ...
     *
     * @param  \Hlx\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Hlx\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Hlx\Support\Enumerable<array-key, TKey>|array<array-key, TKey>  $keys
     * @return static
     */
     ...
     *
     * @param  \Hlx\Contracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \Hlx\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \Hlx\Support\ItemNotFoundException
     * @throws \Hlx\Support\MultipleItemsFoundException
     */
     ...
     * @template TZipValue
     *
     * @param  \Hlx\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
