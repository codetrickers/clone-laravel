...
use Hlx\Auth\Events\Attempting;
use Hlx\Auth\Events\Authenticated;
use Hlx\Auth\Events\CurrentDeviceLogout;
use Hlx\Auth\Events\Failed;
use Hlx\Auth\Events\Login;
use Hlx\Auth\Events\Logout;
use Hlx\Auth\Events\OtherDeviceLogout;
use Hlx\Auth\Events\Validated;
use Hlx\Contracts\Auth\Authenticatable as AuthenticatableContract;
use Hlx\Contracts\Auth\StatefulGuard;
use Hlx\Contracts\Auth\SupportsBasicAuth;
...
use Hlx\Contracts\Session\Session;
use Hlx\Support\Arr;
use Hlx\Support\Facades\Hash;
use Hlx\Support\Str;
use Hlx\Support\Timebox;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \Hlx\Contracts\Session\Session
     */
    protected $session;

    /**
     * The Hlx cookie creator service.
     *
     ...
     * @param  \Hlx\Contracts\Session\Session  $session
     * @param  \Symfony\Component\HttpFoundation\Request|null  $request
     * @param  \Hlx\Support\Timebox|null  $timebox
     * @return void
     */
     ...
     *
     * @return \Hlx\Contracts\Auth\Authenticatable|null
     */
     ...
     *
     * @param  \Hlx\Auth\Recaller  $recaller
     * @return mixed
     */
     ...
     *
     * @param  mixed  $id
     * @return \Hlx\Contracts\Auth\Authenticatable|false
     */
     ...
     *
     * @param  \Hlx\Contracts\Auth\Authenticatable|null  $user
     * @param  array  $credentials
     * @return void
     */
     ...
     *
     * @return \Hlx\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param  \Hlx\Contracts\Cookie\QueueingFactory  $cookie
     * @return void
     */
     ...
     *
     * @return \Hlx\Contracts\Session\Session
     */
