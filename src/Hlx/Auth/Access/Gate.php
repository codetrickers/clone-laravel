...
namespace Hlx\Auth\Access;

use Closure;
use Exception;
use Hlx\Auth\Access\Events\GateEvaluated;
...
class Gate implements GateContract
{
     ...
     *
     * @param  \Hlx\Auth\Access\Response|\Closure|bool  $condition
     * @param  string|null  $message
     * @param  string|null  $code
     * @return \Hlx\Auth\Access\Response
     *
     ...
     *
     * @param  \Hlx\Contracts\Auth\Authenticatable|mixed  $user
     * @return static
     */
