...
use Hlx\Queue\Connectors\BeanstalkdConnector;
use Hlx\Queue\Connectors\DatabaseConnector;
use Hlx\Queue\Connectors\NullConnector;
use Hlx\Queue\Connectors\RedisConnector;
use Hlx\Queue\Connectors\SqsConnector;
use Hlx\Queue\Connectors\SyncConnector;
use Hlx\Queue\Failed\DatabaseFailedJobProvider;
use Hlx\Queue\Failed\DatabaseUuidFailedJobProvider;
use Hlx\Queue\Failed\DynamoDbFailedJobProvider;
use Hlx\Queue\Failed\FileFailedJobProvider;
use Hlx\Queue\Failed\NullFailedJobProvider;
use Hlx\Support\Arr;
use Hlx\Support\Facades\Facade;
use Hlx\Support\ServiceProvider;
use Hlx\SerializableClosure\SerializableClosure;
...
class QueueServiceProvider extends ServiceProvider implements DeferrableProvider
{
     ...
     *
     * @param  \Hlx\Queue\QueueManager  $manager
     * @return void
     */
     ...
     *
     * @param  array  $config
     * @return \Hlx\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \Hlx\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \Hlx\Queue\Failed\DynamoDbFailedJobProvider
     */
