...
use Hlx\Contracts\Cache\Repository as CacheContract;
use Hlx\Contracts\Debug\ExceptionHandler;
use Hlx\Contracts\Events\Dispatcher;
use Hlx\Contracts\Queue\Factory as QueueManager;
use Hlx\Database\DetectsLostConnections;
use Hlx\Queue\Events\JobExceptionOccurred;
use Hlx\Queue\Events\JobPopped;
use Hlx\Queue\Events\JobPopping;
use Hlx\Queue\Events\JobProcessed;
use Hlx\Queue\Events\JobProcessing;
use Hlx\Queue\Events\JobReleasedAfterException;
use Hlx\Queue\Events\JobTimedOut;
use Hlx\Queue\Events\Looping;
use Hlx\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @var \Hlx\Contracts\Debug\ExceptionHandler
     */
     ...
     * @param  \Hlx\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \Hlx\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \Hlx\Contracts\Queue\Queue  $connection
     * @param  string  $queue
    ...
    {
        if ($this->cache) {
            return $this->cache->get('hlx:queue:restart');
        }
    }
     ...
     *
     * @param  int  $status
     * @param  \Hlx\Queue\WorkerOptions|null  $options
     * @return never
     */
     ...
     *
     * @param  \Hlx\Contracts\Queue\Job  $job
     * @return \Hlx\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \Hlx\Contracts\Queue\Job  $job
     * @return \Hlx\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \Hlx\Contracts\Queue\Factory
     */
