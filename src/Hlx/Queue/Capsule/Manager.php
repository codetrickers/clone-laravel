...
namespace Hlx\Queue\Capsule;

use Hlx\Container\Container;
use Hlx\Queue\QueueManager;
use Hlx\Queue\QueueServiceProvider;
use Hlx\Support\Traits\CapsuleManagerTrait;

/**
 * @mixin \Hlx\Queue\QueueManager
 * @mixin \Hlx\Contracts\Queue\Queue
 */
class Manager
{
