...
use Hlx\Queue\Listener;
use Hlx\Queue\ListenerOptions;
...
class ListenCommand extends Command
{
     ...
     *
     * @param  \Hlx\Queue\Listener  $listener
     * @return void
     */
    ...
    {
        $connection = $connection ?: $this->hlx['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->hlx['config']->get(
     ...
     *
     * @return \Hlx\Queue\ListenerOptions
     */
