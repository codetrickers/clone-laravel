...
namespace Hlx\Queue\Jobs;

use Hlx\Container\Container;
use Hlx\Contracts\Queue\Job as JobContract;
use Hlx\Queue\DatabaseQueue;
...
class DatabaseJob extends Job implements JobContract
{
     ...
     * @param  \Hlx\Queue\DatabaseQueue  $database
     * @param  \stdClass  $job
