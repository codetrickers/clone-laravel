...
use Hlx\Contracts\Queue\ClearableQueue;
use Hlx\Contracts\Queue\Queue as QueueContract;
use Hlx\Database\Connection;
use Hlx\Queue\Jobs\DatabaseJob;
use Hlx\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \Hlx\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \Hlx\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \Hlx\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \Hlx\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Hlx\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \Hlx\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Hlx\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \Hlx\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
